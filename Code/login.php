...
<head>
	...
	<?php
    $con = new mysqli('localhost','root','','krenarbank');
    define('bankName', 'Krenaris Bank',true);
...
<body style="background: url(images/bg-login2.jpg);background-size: cover">
...
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
	<br><h4 class="text-center text-white">Enter the Portal</h4>
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
         <form method="POST">
       	<input type="email" value="admin@krenarbank.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="Grafika123!" class="form-control" required placeholder="Enter Password">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="richard@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="Richard2021!" class="form-control" required placeholder="Enter Password">
